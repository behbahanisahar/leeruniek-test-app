...
import NoteItem from "../entities/note-item";
import planItem from "../entities/plan-item";

export default class planMockData {
  public static PLAN: planItem = {
    id: 1,
    name: "Group plan M/E",
    userCreated: "John Doe",
  };
  public static categories: CategoryItem[] = [
    {
      id: 1,
      isArchived: false,
      name: "Mathematics",
